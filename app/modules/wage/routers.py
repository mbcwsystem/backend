...
@router.post("/user", response_model=schemas.UserWageResponse, summary="유저 전용 시급 설정")  #
...
@router.get(
    "/user/{user_id}", response_model=list[schemas.UserWageResponse],  summary="유저 전용 시급 조회"
)  # 유저 전용 시급 조회
